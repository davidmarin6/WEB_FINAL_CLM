...
export const ChatMockup = () => {
  ...
  return (
    <motion.div
      className="glass-card max-w-md mx-auto float cursor-pointer group"
    ...
    >
      {/* Hover overlay */}
      <div className="absolute inset-0 bg-primary/0 group-hover:bg-primary/5 transition-colors duration-300 rounded-2xl z-10 flex items-center justify-center opacity-0 group-hover:opacity-100">
        <div className="bg-foreground/80 text-background px-4 py-2 rounded-full text-sm font-medium">
          Probar chatbot →
        </div>
      </div>
